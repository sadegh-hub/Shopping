...

{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager ,ApplicationRoleManager Role)
        {
        ...
        public ActionResult Roles()
        {
            ...
            return View(roles.Select(x => new RoleViewModels() { ID = x.Id, Name = x.Name }));
        }
        ...
        public ActionResult CreateRole(RoleViewModels model)
        {
